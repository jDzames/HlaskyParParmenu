...
public enum HlaskyList {
    ...
    public final Song[] hlaskySmajdalf = {new Song(R.raw.pisnickasmajdalfa, "Trápna písnička", "Smajdalf"),
            new Song(R.raw.magicseneflaka, "Magič se nikdy nefláka", "Smajdalf"),
            new Song(R.raw.smiech, "Hehehuhu", "Fritol ft. Šmajdalf"),
            new Song(R.raw.nakupysmajdalfa, "Nákupy Šmajdalfa", "Fritol ft. Šmajdalf"),
            new Song(R.raw.cervenykolecko, "Červený kolečko na dlani", "Smajdalf"),
            new Song(R.raw.nesezerto, "Nesežer to", "Smajdalf"),
            new Song(R.raw.zdrhamnesezerto, "Zdrhám, nsežer to", "Smajdalf"),
            new Song(R.raw.nesezralsho, "Nesežrals ho?(s BafikiBaf a se Slimem)", "Smajdalf"),
            new Song(R.raw.smajdalfkouri, "Šmajdalf kouři", "Smajdalf"),
            new Song(R.raw.skushelium, "Mnel bys skusit hélium", "Smajdalf ft. Smradupán"),
            new Song(R.raw.smoulalala, "Šmoulalala", "Smajdalf ft. Smradupán"),
            new Song(R.raw.svetlusky, "Svetlušky", "Smajdalf"),
            new Song(R.raw.svetluskasupgradem, "Težká válečná svetluška", "Smajdalf"),
            new Song(R.raw.bezbalounkovsivprdeli, "Bez balounkov si v prdeli", "Smajdalf"),
            new Song(R.raw.comnedrzi, "Co mne drží ve vzduchu", "Smajdalf"),
            new Song(R.raw.radilisme, "Řádili sme", "Smajdalf"),
            new Song(R.raw.toaletakveverky, "Toaleťák a veverky", "Smajdalf")
    };
